...
const faqs = [
  ...
  { q: "Funciona para qualquer tipo de negócio?", a: "Nosso método é especialmente eficaz para negócios locais, lojas, clínicas, restaurantes e prestadores de serviço. Se você atende clientes via WhatsApp, funciona para você." },
  { q: "Preciso ter experiência com marketing digital?", a: "Não. Cuidamos de toda a estratégia, criação e gestão. Você só precisa atender os clientes que chegam." },
  { q: "E se eu já tentei anunciar e não deu certo?", a: "A maioria dos negócios que nos procura já tentou por conta própria ou com agências genéricas. Nosso diferencial é o método proprietário focado em conversão via WhatsApp." },
        ...
        <div className={`max-w-3xl mx-auto ${isVisible ? "animate-fade-up" : "opacity-0"}`}>
          <div className="text-center mb-12 space-y-4">
            ...
            <h2 className="font-display text-3xl sm:text-4xl font-bold">
              Perguntas <span className="text-primary text-glow-yellow">frequentes</span>
            </h2>
          </div>
